...
//Top level Published Business Service input value object for getAddressBookV2
public class GetAddressBookV2 extends ValueObject implements Serializable {
    public GetAddressBookV2() {
     ...
     * the GetAddressBookV2 vo values into the corresponding InternalGetAddressBookWhereFields values 
    ...
    public E1MessageList mapFromPublished(IContext context, 
        ...
        vo.setSzGlobalLocatorNumber(this.getGlobalLocatorNumber());
