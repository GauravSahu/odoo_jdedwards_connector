 ...
 */
public class GetContact extends ValueObject implements Serializable {
    /**
     ...
     */
    private String contacTypeCode = null;
    ...
    public void setContacTypeCode(String contacType) {
        this.contacTypeCode = contacType;
    }

    public String getContacTypeCode() {
        return contacTypeCode;
    }
    ...
    public E1MessageList mapFromPublished(IContext context, 
        ...
        vo.setF0111_NTYP(this.contacTypeCode);
