 ...
 *
 */
public class ConfirmProcessAddressBookV2 extends MessageValueObject implements Serializable {
     ...
     */
     ...
     /**
      * Global Locator Number<br>
      * <p>
      *    A unique number that can identify a physical location or legal entity <br>
      *    The GLN has a 13 digit numeric data structure and is composed of <br>
      *    1) GS1 company prefix - assigned by GS1 member organization <br>
      *    2) Location Reference - allocated by the company for a specific location <br>
      *    3) Check Digit - Calculated according to standard algorithm <br>
      * <br>
      * <br>
      * </p>
      * EnterpriseOne Key Field: No <br>
      * EnterpriseOne Alias: GAN8 <br>
      * EnterpriseOne field length:  13 (Data exceeding this length will be truncated)<br>
      */
     private String globalLocatorNumber = null;
     
    private ElectronicAddress[] electronicAddresses;

    public ConfirmProcessAddressBookV2() {

    }

    public ConfirmProcessAddressBookV2(InternalProcessAddressBook internalVO) {
        ...
        this.setGlobalLocatorNumber(internalVO.getSzGlobalLocatorNumber());
    ...
    public void setGlobalLocatorNumber(String globalLocatorNumber) {
        this.globalLocatorNumber = globalLocatorNumber;
    }

    public String getGlobalLocatorNumber() {
        return globalLocatorNumber;
    }
}
