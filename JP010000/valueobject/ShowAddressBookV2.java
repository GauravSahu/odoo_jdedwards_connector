...
public class ShowAddressBookV2 extends MessageValueObject {
    public ShowAddressBookV2() {
    }

    public ShowAddressBookV2(InternalGetAddressBook internalVO) {
        if (internalVO.getQueryResults() != null) {

            addressBookResult = 
                    new AddressBookResultV2 [internalVO.getQueryResults().size()]; /* create a new array big enough to hold all records in the result set */
                 ...
                 i++) /* loop through all records in the result set */
            {
                ...
                addressBookResult[i] = 
                        new AddressBookResultV2(); /* create a new object in array */
                //Entity
                ...
                // GLN Number Addition
               addressBookResult[i].setGlobalLocatorNumber(intVOQueryResult.getSzGlobalLocatorNumber());
                //top level
    ...
    AddressBookResultV2[] addressBookResult;

    public void setAddressBookResult(AddressBookResultV2[] addressBookResult) {
        this.addressBookResult = addressBookResult;
    }

    public AddressBookResultV2[] getAddressBookResult(int i) {
        if (i >= 0 && i < addressBookResult.length)
            return addressBookResult;
        return null;
    }

    public AddressBookResultV2[] getAddressBookResult() {
        return addressBookResult;
    }
